...
class WordFinderGame {
    ...
    setupSocket() {
        ...
        // Re-fetch lobby list when lobbies change (if on join screen)
        this.socket.on('lobbiesChanged', () => {
            if (this.screens.joinLobby.style.display !== 'none') {
    ...
    bindEvents() {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (e.key === 'Enter') this.submitWord(); else if (e.key === 'Escape') { if (this.isChangeMode) this.cancelChangeMode(); else if (this.isSwapMode) this.cancelSwapMode(); else this.clearSelection(); }
        });
    }
    ...
    handleTileClick(row, col) {
        ...
        if (this.isChangeMode) { this.showLetterPicker(row, col); return; }
    ...
    showLetterPicker(row, col) {
        ...
        this.elements.letterPicker.style.display = 'flex';
    }
    ...
    updatePowerupButtons() {
        ...
        this.elements.shuffleBtn.disabled = gems < 1; this.elements.swapBtn.disabled = gems < 3; this.elements.hintBtn.disabled = gems < 2; this.elements.changeBtn.disabled = gems < 4;
    }
